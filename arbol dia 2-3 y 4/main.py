...
class FileTree:
    ...
    def eliminar(self, ruta):
        ...
        if nodo is None or nodo == self.root:
            print("No se puede eliminar:", ruta)
            return
    ...
    def renombrar(self, node_id, nuevo_nombre):
        if node_id not in self.map:
            ...
            return
        self.map[node_id].name = nuevo_nombre
...
def menu():
    ...
    while True:
        ...
        print("5. Eliminar nodo (rm)")
        print("6. Renombrar nodo (rename)")
        print("7. Mover nodo (mv)")
        print("8. Altura del árbol")
        print("9. Tamaño del árbol")
        print("10. Guardar")
        print("11. Cargar")
        print("12. Salir")
        ...
        if op == "1":
            ...
            ruta = input("Ruta del nodo a eliminar: ")
            tree.eliminar(ruta)
            ...
            origen = input("Ruta origen: ")
            destino = input("Ruta destino: ")
            tree.mover(origen, destino)

        elif op == "8":
            print("Altura del árbol:", tree.altura())

        elif op == "9":
            print("Tamaño del árbol:", tree.tamaño())
